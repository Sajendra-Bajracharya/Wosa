...
if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM user_manager WHERE id = $user_id";
...
if (isset($_GET['search'])) {
    ...
    $users_query = "SELECT * FROM user_manager WHERE username LIKE '%$search%' OR email LIKE '%$search%' OR phone_number LIKE '%$search%' ORDER BY created_at DESC";
} else {
    $users_query = "SELECT * FROM user_manager ORDER BY created_at DESC";
}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="admin_user_view.php?id=<?php echo $user['id']; ?>" class="btn btn-primary" title="View Details">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 30px;">
                                    <i class="fas fa-users" style="font-size: 3rem; color: #bdc3c7;"></i>
                                    <p style="margin-top: 10px; color: #7f8c8d;">No users found</p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
